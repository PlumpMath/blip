...
function menu:draw()
  ...
  -- love.graphics.printf("\"Oh and by the way we found this minor glitch in our systems where for some reason\"", 0, h/2.8+80, w, "center")
  -- love.graphics.printf("\"our engines go faster and faster each time we ping our sonar..\"", 0, h/2.8+100, w, "center")
  ...
  love.graphics.printf("\"We have this glitch in our system when we use sonar", 0, h/2.8+100, w, "center")
  love.graphics.printf("the engines go faster and faster..\"", 0, h/2.8+120, w, "center")
